...
<pre><code class="java language-java">class SingletonLazy {
    private static SingletonLazy instance;
...
<p>简单工厂示意图如下：</p>
<p><img src="https://images.gitbook.cn/35024ce0-e066-11e9-bc61-0549c31758ee" alt="1" /></p>
<p>简单工厂<strong>代码实现</strong>：</p>
<pre><code class="java language-java">class Factory {
...
<p>抽象工厂实现代码如下：</p>
<pre><code class="java language-java">public class AbstractFactoryTest {
   public static void main(String[] args) {
       // 抽象工厂
...
<h5 id="3-1">3）代码调用</h5>
<pre><code class="java language-java">public class ObserverTest {
    public static void main(String[] args) {
        // 定义发布者
...
<h4 id="6">6.什么是装饰器模式？</h4>
<p>答：装饰器模式是指动态地给一个对象增加一些额外的功能，同时又不改变其结构。</p>
...
<h5 id="1-2">1）定义顶层对象，定义行为</h5>
<pre><code class="java language-java">interface IPerson {
    void show();
}
</code></pre>
<h5 id="2-2">2）定义装饰器超类</h5>
<pre><code class="java language-java">class DecoratorBase implements IPerson{
    IPerson iPerson;
...
<h5 id="3-2">3）定义具体装饰器</h5>
<pre><code class="java language-java">class Jacket extends DecoratorBase {
...
<p><img src="https://images.gitbook.cn/55a69fa0-e066-11e9-bc61-0549c31758ee" alt="2" /></p>
<p>适配器实现代码如下：</p>
<pre><code class="java language-java">/*
 * 传统的充电线 MicroUSB
 */
...
<pre><code class="java language-java">class Person implements Comparable{
    private Integer age;
