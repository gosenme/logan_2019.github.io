...
### 技术栈
- Go、Python基础知识扎实,熟悉常用的数据结构、多线程和协程,了解算法;
- Go使用Gin, Python使用Sanic/Flask提供Http接口;
...
### 实习经历
- **深圳市前海喜越科技有限公司** *2018.4-2019.7/ 后端开发工程师*
...
- 供应商对接
  ...
  > 3. 使用Go基于`go routine`开发Koasys集团数据拉取工具;
  > 4. 使用Go开发拉取报价、二次验价、订单创建、订单查询、订单取消接口;
...
- HDataMindr系统
  ...
  > 5. 使用Go对接计算接口，编写shell脚本用于封装任务并提交镜像至集群。
