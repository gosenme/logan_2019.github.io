---
title: Angular 基础教程-80
---
<article id="topicContainer" class="column_content"><h2 class="topic_title"></h2><div><h3 id="rxjs">RxJS 简介</h3>
<p><a href="http://reactivex.io/">RxJS 的官方网站请点击这里</a>，在官方网站上面有关于 RxJS 的详细介绍、入门文档、技术特性。</p>
<p>所以这篇文章不会重复文档上已经有的内容，而是从另外一个视角，带你领略 RxJS 的核心用法。</p>
...
<p><img width="70%" src="https://images.gitbook.cn/5cc0f6b0-f385-11e8-aeb7-01d6aed3aa05"></p>
...
<p>当然，Promise 的作用不止于此，如果你想更细致地研究 Promise，<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">请看 MDN 上的这篇资料</a>。</p>
...
<p><img width="50%" src="https://images.gitbook.cn/cdd83a20-f385-11e8-8426-b15c0859cf17"></p>
<p>依次给 3 块代码来示范一下：</p>
<pre><code>let promise = new Promise(resolve =&gt; {
    setTimeout(() =&gt; {
        resolve('---promise timeout---');
...
<p>Observable 里面提供了数百个这样的“操作符”，<a href="http://reactivex.io/documentation/operators.html">完整的列表和 API 文档请参考这里</a>。</p>
