...
<h3 id="-3">备忘录模式的模型抽象</h3>
<h4 id="-4">类图</h4>
<p>备忘录模式的类图表示如下：</p>
<p><img src="http://images.gitbook.cn/1e114240-7daa-11e8-8a07-2345656531ad" alt="enter image description here" /></p>
...
<p><img src="http://images.gitbook.cn/2b1c08d0-7daa-11e8-8748-9f97e9dc7c3b" alt="enter image description here" /></p>
<h4 id="-5">代码框架</h4>
<p>因为升级版的备忘录模式比较通用，我们可以抽象出升级版备忘录模式的代码框架模型。</p>
<pre><code class="python language-python">from copy import deepcopy
