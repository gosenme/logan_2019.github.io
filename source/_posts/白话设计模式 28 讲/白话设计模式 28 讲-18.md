...
<h4 id="-4">类图</h4>
<p>享元模式的类图表示如下：</p>
<p><img src="https://images.gitbook.cn/2997def0-833e-11e8-9e1d-f13ca808ab04" alt="enter image description here" /></p>
<h4 id="-5">基于框架的实现</h4>
...
<pre><code class="python language-python">def testPigment2():
