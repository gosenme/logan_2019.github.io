...
title: -第10课：建立统一语言
---
<article id="topicContainer" class="column_content"><h2 class="topic_title"></h2><div><p>统一语言是提炼领域知识的产出物，<strong>获得统一语言就是需求分析的过程，也是团队中各个角色就系统目标、范围与具体功能达成一致的过程。</strong></p>
...
<p><img src="http://images.gitbook.cn/6f680680-7a79-11e8-ae51-d5fb97616c42" alt="enter image description here" /></p>
...
<pre><code class="java language-java">package practiceddd.projectmanager.scrumcontext.domain;
